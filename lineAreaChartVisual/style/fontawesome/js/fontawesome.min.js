        ...
        a.found && n.found
          ? ((C = (k = K).children),
            ...
            (U = {
              tag: "defs",
              children: [
                { tag: "clipPath", attributes: { id: F }, children: ((A = L), "g" === A.tag ? A.children : [A]) },
                D,
              ],
            }),
            C.push(U, {
              tag: "rect",
              attributes: $(
                { fill: "currentColor", "clip-path": "url(#".concat(F, ")"), mask: "url(#".concat(H, ")") },
                zt
              ),
            }),
      ...
      icon: Array.isArray(a)
        ? {
            ...
            children: [
              ...
              {
                tag: "path",
                attributes: { class: "".concat(et.familyPrefix, "-").concat(Y.PRIMARY), fill: "currentColor", d: a[1] },
              },
            ],
          }
        ...
        if (!f || (e && e.getAttribute(C) === s && e.getAttribute(O) === u)) a();
          ...
          (m.attributes[w] = h),
            ye(f, s)
              .then(function (t) {
                var e = jt(
                    $({}, d, { icons: { main: t, mask: Kt() }, prefix: s, iconName: u, extra: m, watchable: !0 })
                  ),
